	...
	packs := []dumplings.Product{
		{
			...
			Price:       5.00,
			Image:       "https://res.cloudinary.com/sugrobov/image/upload/v1651932686/repos/momos/8dee5a92281746aa887d6f19cf9fdcc7.jpg",
		},
		{
			ID:          2,
			Name:        "Хинкали",
			...
			Price:       3.50,
			Image:       "https://res.cloudinary.com/sugrobov/image/upload/v1651932686/repos/momos/50b583271fa0409fb3d8ffc5872e99bb.jpg",
		},
		{
			ID:          3,
			Name:        "Манты",
